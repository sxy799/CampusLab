...
<title>实验管理——增加实验信息</title>
<link rel="stylesheet" href="http://cdn.static.runoob.com/libs/bootstrap/3.3.7/css/bootstrap.min.css">  
<script src="http://cdn.static.runoob.com/libs/jquery/2.1.1/jquery.min.js"></script>
<script src="http://cdn.static.runoob.com/libs/bootstrap/3.3.7/js/bootstrap.min.js"></script>
</head>
<body>
    <h2 style = "text-align:center;" >增加实验信息登记表</h2>
  <form action="do_func_Add.php" method="post" style = "padding-left:500px;">
  ...
  <tr>
     <div class="input-group" style = "width:300px; margin-top:20px;">
	   <span class="input-group-addon">负责人编号</span>
	   <input  name="lab_mangager" type="text" class="form-control" placeholder="输入负责人编号" >
	 </div>
  </tr>
   </tbody>
 </table>
